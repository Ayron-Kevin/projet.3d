...
VALUES('$nome_cont', '@cpf', '@rg', '$profissao', '$titulo', $est_civ, '$dt_nasc','$sexo','$rua_cont','$num_cont','$bairro'
'$cidade', '$uf_cont','$cep_cont','$tel_cont','$cel_cont','$email_cont','$escolariedade','$rend_fam,','$membros,','$fantasia','$razao','cnpj','$cond','$num_ir','$rua_emp','num_emp','$bairro_emp','$cidade_emp','$uf_emp','$cep','$tel_emp','$email_emp','$faturamento','$fat_mensal','$segmento','$dt_abertura', )";
